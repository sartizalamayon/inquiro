...
import { ArrowRight, Brain, Share2, Search, BarChart3, ChevronRight, FileText, Edit3 } from "lucide-react"
        ...
        <div className="container relative px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center text-center space-y-8 max-w-3xl mx-auto">
            ...
            <div className="pt-8 w-full max-w-4xl">
              <div className="relative w-full aspect-[16/9] rounded-xl overflow-hidden border border-zinc-200 shadow-xl dark:border-zinc-800">
                <div className="absolute inset-0 bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center">
                  <div className="w-full h-full bg-gradient-to-br from-zinc-50 to-zinc-200 dark:from-zinc-800 dark:to-zinc-950 opacity-50"></div>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-[80%] h-[80%] rounded-lg bg-white/90 dark:bg-zinc-900/90 shadow-lg p-4 flex flex-col">
                      <div className="flex items-center mb-4">
                        <div className="w-3 h-3 rounded-full bg-zinc-300 dark:bg-zinc-700 mr-2"></div>
                        <div className="w-3 h-3 rounded-full bg-zinc-300 dark:bg-zinc-700 mr-2"></div>
                        <div className="w-3 h-3 rounded-full bg-zinc-300 dark:bg-zinc-700"></div>
                        <div className="ml-4 h-4 w-1/3 bg-zinc-200 dark:bg-zinc-700 rounded"></div>
                      </div>
                      <div className="flex-1 flex">
                        <div className="w-1/4 border-r border-zinc-200 dark:border-zinc-800 p-2">
                          <div className="h-4 w-3/4 bg-zinc-200 dark:bg-zinc-700 rounded mb-3"></div>
                        ...
                        <div className="flex-1 p-2">
                          <div className="h-5 w-1/2 bg-zinc-200 dark:bg-zinc-700 rounded mb-4"></div>
                          <div className="h-3 w-full bg-zinc-100 dark:bg-zinc-800 rounded mb-2"></div>
                          <div className="h-3 w-full bg-zinc-100 dark:bg-zinc-800 rounded mb-2"></div>
                          <div className="h-3 w-3/4 bg-zinc-100 dark:bg-zinc-800 rounded mb-4"></div>
                          <div className="h-20 w-full bg-zinc-100 dark:bg-zinc-800 rounded"></div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="container px-4 md:px-6 relative mx-auto">
          <div className="max-w-3xl mx-auto">
            <div className="relative overflow-hidden rounded-2xl border border-zinc-200 bg-white p-8 shadow-lg dark:border-zinc-800 dark:bg-zinc-950">
              <div className="absolute -top-16 -right-16 h-40 w-40 rounded-full bg-zinc-100 blur-3xl dark:bg-zinc-800/50"></div>

              <div className="relative">
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                  <div className="space-y-2">
                    <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Ready to Transform Your Research?</h2>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 min-[400px]:gap-3 pt-4">
                    <Link href="/signup">
                      <Button size="lg" className="gap-1.5 h-12 px-6">
